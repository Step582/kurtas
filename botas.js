...
(function () {
    ...
    var basicBot = {
        ...
        settings: {
            ...
            motdEnabled: false,
            motdInterval: 5,
            motd: "Sveiki,  atvykę į atnaujintą vasaros sezono kambarį linkime praleisti gerai laiką, o svarbiausia išsirinkti geriausias savo dainas!.",
            filterChat: true,
            ...
            komandosCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        var link = "(https://nbot.lt/#commands)";
            ...
            sourceCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat('/me This bot was created by ' Dėde ', Bet šiuo metų ' -TheRok4s ".");
                    }
                }
            },
